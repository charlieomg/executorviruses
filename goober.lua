...
game.StarterGui:SetCore("SendNotification", {Text="time to cause chaos", Title="game fucked xd"})
...
if CoreGui:FindFirstChild("RemoteScanner") then
    CoreGui.RemoteScanner:Destroy()
end

local scannerGui = Instance.new("ScreenGui")
scannerGui.Name = "RemoteScanner"
...
currentRemote.Size = UDim2.new(1, -10, 0, 25)
currentRemote.Position = UDim2.new(0, 5, 0, 25)
currentRemote.BackgroundTransparency = 1
currentRemote.Text = "Trying: ..."
currentRemote.TextColor3 = Color3.fromRGB(200, 200, 200)
currentRemote.TextXAlignment = Enum.TextXAlignment.Left
currentRemote.Font = Enum.Font.SourceSans
currentRemote.TextSize = 15
currentRemote.Parent = mainFrame

local foundRemoteLabel = Instance.new("TextLabel")
foundRemoteLabel.Size = UDim2.new(1, -10, 0, 25)
foundRemoteLabel.Position = UDim2.new(0, 5, 0, 50)
foundRemoteLabel.BackgroundTransparency = 1
foundRemoteLabel.Text = "Found: None"
foundRemoteLabel.TextColor3 = Color3.fromRGB(200, 200, 200)
foundRemoteLabel.TextXAlignment = Enum.TextXAlignment.Left
foundRemoteLabel.Font = Enum.Font.SourceSans
foundRemoteLabel.TextSize = 15
foundRemoteLabel.Parent = mainFrame

local foundRemote = nil
for _, obj in ipairs(ReplicatedStorage:GetDescendants()) do
    if obj:IsA("RemoteEvent") then
        currentRemote.Text = "Trying: " .. obj.Name
        local name = string.lower(obj.Name)
        if name:find("destroy") or name:find("delete") or name:find("break")
        or name:find("remove") or name:find("hit") then
            foundRemote = obj
            foundRemoteLabel.Text = "Found: " .. obj.Name
            break
        end
    end
end
...
top_2.Text = "dougs skidded febypass"
...
credits.Text = "Script Modified by doug"
